...
export const EFFECTS = {
  ...
  clarity: { sticky: true, name: "Clarity", glyph: "◎", desc: "You see the numbers. Whether this is a gift is unclear." },
  old_age: { sticky: true, name: "Old Age", glyph: "⌛", desc: "Your knees know it. Your court knows it. Death is filling in the forms.", years: 12 },
  elixir: { sticky: true, name: "Elixir", glyph: "⚗", desc: "Something in your blood does not want you to die." },
  doomed: { sticky: true, name: "The Bargain", glyph: "✦", desc: "You owe the Bargainer. Every year you refuse him, he gets closer." },
  love: { sticky: true, name: "In Love", glyph: "♥", desc: "Dangerous. Kings who die in love die twice." },
  toadstool: { sticky: true, name: "Blue Cap", glyph: "☂", desc: "You ate the mushroom. Everyone looks like a frog now. Everyone is a frog now." },
  spy_network: { name: "Quiet Hands", glyph: "◑", desc: "The Whisperer hears everything. Plots come to you before they mature." },
  married: { sticky: true, name: "Married", glyph: "⚭", desc: "You have a queen. She has opinions." },
  heir: { sticky: true, name: "An Heir", glyph: "♙", desc: "Your line continues. That makes you replaceable." },
  excommunicated: { sticky: true, name: "Excommunicated", glyph: "✕", desc: "The Flame has cast you out. Faith cannot rise while this holds.", drift: { faith: -2 } },
  wanted: { sticky: true, name: "Marked", glyph: "◌", desc: "The Guild of Quiet Hands has your name. They are patient." },
};
