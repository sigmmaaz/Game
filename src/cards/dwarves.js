...
export default [
  // ---------- everyday: the Thane ----------
  {
    ...
    left: { label: "Read them.", fx: { faith: 3, gold: 5 } },
    right: { label: "Round it off.", fx: { people: 3, gold: 5 }, set: ["dwarf_grudge"] },
  },
  {
  ...
  },
  {
    ...
    right: { label: "It's a stone.", fx: { gold: 5 }, set: ["dwarf_grudge"] },
  },
  {
    ...
    left: { label: "Accept the chest.", fx: { gold: 20 }, set: ["dwarf_chest_leased"], next: { id: "dwarf_thane_chest", delay: 5 } },
  ...
  },
  {
    ...
    right: { label: "Keep the chest.", fx: { gold: 15 }, set: ["dwarf_grudge"] },
  },
  {
    ...
    left: { label: "Sell.", fx: { gold: 30, people: -10 }, set: ["dwarf_mining"], next: { id: "dwarf_mining_peasant", delay: 3 } },
    right: { label: "The hills stay whole.", fx: { people: 5 } },
  },
  {
    ...
    right: { label: "Cows can stand.", fx: { people: -10, faith: -5, gold: 5 } },
  },
  {
    ...
    left: { label: "Send my brother.", fx: { people: -5, gold: 15 } },
    right: { label: "Keep the uncle.", fx: { people: 3, gold: 5 }, set: ["dwarf_grudge"] },
  },
  {
    ...
    left: { label: "Sign here.", fx: { gold: 3 } },
  ...
  },
  {
    ...
    right: { label: "Send flowers.", fx: { people: 3, gold: 5 }, set: ["dwarf_grudge"] },
  },
  ...
  // ---------- everyday: Master Hesk ----------
  {
    ...
    left: { label: "Rebuild it.", fx: { gold: -10, people: 5, army: 5 } },
  ...
  },
  {
    ...
    left: { label: "Without the cannon.", fx: { gold: -5, people: 5 } },
    right: { label: "With the cannon.", fx: { gold: -10 }, random: [
  ...
  },
  {
    ...
    left: { label: "Take the river.", fx: { gold: -20, people: 15 } },
    right: { label: "The river stays.", fx: { people: -5, gold: 5 } },
  },
  {
    ...
    right: { label: "Return him to Borri.", fx: { gold: 15, faith: 3 } },
  },
  {
    ...
    left: { label: "Water bellows.", fx: { army: 10, people: -10, gold: -5 } },
    right: { label: "Keep the boys.", fx: { people: 5, army: -5, gold: 5 } },
  },
  {
  ...
  // ---------- everyday: Dunna ----------
  {
    ...
    right: { label: "Everyone tithes.", fx: { faith: 10, gold: 8 }, set: ["dwarf_grudge"] },
  },
  {
    ...
    left: { label: "Grant it.", fx: { gold: 15, people: 5 } },
  ...
  },
  {
    ...
    right: { label: "Use our yard.", fx: { gold: 10, people: 3 }, set: ["dwarf_grudge"] },
  },
  {
    ...
    right: { label: "It was accurate.", fx: { people: 5, gold: 5 }, set: ["dwarf_grudge"] },
  },
  {
    ...
    left: { label: "Take them.", fx: { gold: 25, people: -15 } },
    right: { label: "Not my goblins.", fx: { army: 3 } },
  },
  ...
  // ---------- everyday: Grombold ----------
  {
    ...
    left: { label: "Shoe them.", fx: { gold: -15, army: 15 } },
    right: { label: "The horses have managed.", fx: { army: -5, gold: 5 } },
  },
  {
    ...
    left: { label: "A year.", fx: { people: 5, army: -5, faith: -3, gold: 5 } },
    right: { label: "He's a prince.", fx: { people: -3, gold: 3 } },
  },
  {
    ...
    right: { label: "The crack is holy.", fx: { faith: 10, people: -5, gold: 5 } },
  },
  {
    ...
    left: { label: "Fit me.", fx: { gold: -15, army: 10 }, set: ["dwarf_armor"] },
    right: { label: "I don't fall off horses.", fx: { gold: 5 } },
  },
  {
  ...
  // ---------- everyday: humans on the subject of dwarves ----------
  {
    ...
    left: { label: "Neither.", fx: { gold: 15 } },
    right: { label: "Hire the dwarf who did it.", fx: { gold: 20, people: -5 } },
  },
  {
  ...
  },
  {
    ...
    text: "Borri, under a flag of contract. \"Your Marshal is in our front hall. It's where we keep guests and floods. He can leave with his men or stay with the flood. The peace is short, for once.\"",
    left: { label: "Sign.", fx: { gold: -20, army: -10 }, removeEffect: "war" },
  ...
  },
  {
    ...
    right: { label: "Let her read.", fx: { people: 5, faith: -5, gold: 5 } },
  },
  {
  ...
  },
  {
    ...
    right: { label: "What did you sign?", fx: { gold: -5, people: 3 } },
  },
  ...
  // ---------- chain: the inherited debt ----------
  {
    ...
    left: { label: "Pay the grandsons.", fx: { gold: -15, people: 5 } },
    right: { label: "No well, no wages.", fx: { gold: 10 }, set: ["dwarf_grudge"], next: { id: "dwarf_debt_2", delay: 3 } },
  },
  {
    ...
    right: { label: "Salt is salt. Mine.", fx: { gold: 10 }, next: { id: "dwarf_debt_3", delay: 3 } },
  },
  {
    id: "dwarf_debt_3", char: "dwarf_thane", chainOnly: true,
    text: "\"The lien has matured. Clause forty converts unpaid liens to labour. Clause forty-one names the debtor's person as collateral of last resort. I've never read forty-one aloud. I'd rather not.\"",
    left: { label: "Pay it. All of it.", fx: { gold: -25 } },
  ...
  // ---------- chain: the loan ----------
  {
    ...
    right: { label: "Take the gold.", fx: { gold: 30 }, set: ["dwarf_loan"], next: { id: "dwarf_loan_2", delay: 4 } },
  },
  {
  ...
  },
  {
    ...
    right: { label: "Next year.", fx: { gold: 5 }, set: ["dwarf_loan_late"], next: { id: "dwarf_loan_3", delay: 2 } },
  },
  {
    ...
    left: { label: "Pay everything.", fx: { gold: -25 }, unset: ["dwarf_loan", "dwarf_loan_late"] },
  ...
  },
  {
    ...
    right: { label: "Pay in full. Now.", fx: { gold: -35, people: -10 }, unset: ["dwarf_loan", "dwarf_loan_late"] },
  },
  {
    ...
    left: { label: "Settle it.", fx: { gold: -20 }, unset: ["dwarf_loan", "dwarf_loan_late"] },
    right: { label: "Money's for spending.", fx: { gold: 10, people: 5 }, set: ["dwarf_grudge"] },
  },
  ...
  },
  {
    ...
    left: { label: "Build it.", fx: { gold: -25 }, next: { id: "dwarf_vault_3", delay: 3 } },
    right: { label: "Too much.", fx: { gold: 5 }, next: { id: "dwarf_vault_haggle", delay: 0 } },
  },
  {
    ...
    left: { label: "A smaller door.", fx: { gold: -15 }, next: { id: "dwarf_vault_3", delay: 4 } },
  ...
  },
  {
    ...
    right: { label: "He's a Marshal. He has horses.", fx: { army: -10, gold: 5 }, next: { id: "dwarf_hesk_3", delay: 3 } },
  },
  {
    ...
    left: { label: "Find the one.", fx: { gold: -5, people: 5 }, next: { id: "dwarf_hesk_4", delay: 2 } },
  ...
  },
  {
    ...
    right: { label: "Nothing clever. No.", fx: { army: -5, people: 5, gold: 10 } },
  },
  {
    ...
    left: { label: "Move the barrels.", fx: { gold: -5, faith: 5 } },
  ...
  },
  {
    ...
    left: { label: "Buy the ground back.", fx: { gold: -25, people: 5 } },
    right: { label: "Get out from under my city.", fx: { gold: 5 }, set: ["dwarf_grudge"], next: { id: "dwarf_tunnel_3", delay: 3 } },
  },
  {
    ...
    left: { label: "Pay for pipes.", fx: { gold: -10, people: 5 } },
    right: { label: "Boil it.", fx: { people: -10, gold: 5 }, random: [
      { chance: 0.7, fx: {} },
  ...
  // ---------- chain: the treaty ----------
  {
    ...
    left: { label: "Read it.", fx: {}, next: { id: "dwarf_treaty_2", delay: 0 } },
  ...
  },
  {
    ...
    right: { label: "Sign as written.", fx: { gold: 10, faith: -5 }, set: ["dwarf_contract_signed", "dwarf_bad_treaty"], effect: "prosperity", next: { id: "dwarf_treaty_bad", delay: 3 } },
  },
  {
  ...
  },
  {
    ...
    right: { label: "Withdraw the clause.", fx: { gold: 10 }, set: ["dwarf_contract_signed"], effect: "prosperity" },
  },
  {
    ...
    left: { label: "Rename them back.", fx: { gold: -10 }, set: ["dwarf_grudge"], unset: ["dwarf_bad_treaty"] },
  ...
  // ---------- chain: the mountain pass ----------
  {
    ...
    right: { label: "Ship by troll.", fx: { gold: -5, people: -3 } },
  },
  {
    ...
    left: { label: "Sign the waiver.", fx: { gold: 20 }, set: ["dwarf_pass_open"], next: { id: "dwarf_pass_3", delay: 2 } },
  ...
  },
  {
    ...
    left: { label: "Close the pass.", fx: { gold: -5, people: 5 }, unset: ["dwarf_pass_open"] },
  ...
  },
  {
    ...
    right: { label: "A bishop is not freight.", fx: { faith: 5, gold: 8 }, set: ["dwarf_grudge"] },
  },
  ...
  // ---------- chain: the forge ----------
  {
    ...
    left: { label: "Make the crown.", fx: { gold: -15 }, next: { id: "dwarf_forge_crown", delay: 2 } },
    right: { label: "Make me a sword instead.", fx: { gold: -10 }, next: { id: "dwarf_forge_sword", delay: 2 } },
  },
  {
  ...
  },
  {
    ...
    left: { label: "Wear it.", fx: { faith: 10, people: 10 }, set: ["dwarf_crown"], next: { id: "dwarf_crown_inspect", delay: 6 } },
    right: { label: "Melt it down.", fx: { gold: 15, army: -5 }, set: ["dwarf_grudge"] },
  },
  {
  ...
  },
  {
    ...
    left: { label: "Give it to the Marshal.", fx: { army: 15 } },
  ...
  },
  {
    ...
    right: { label: "Not disclosed by me.", fx: { gold: 5 }, set: ["dwarf_grudge"], next: { id: "dwarf_under_3", delay: 2 } },
  },
  {
  ...
  },
  {
    ...
    left: { label: "We shut it together.", fx: { gold: 15, army: -15, faith: -5 }, set: ["dwarf_under_sealed"], unset: ["dwarf_grudge"] },
  ...
  // ---------- chain: the grudge ledger ----------
  {
    ...
    left: { label: "Settle in gold.", fx: { gold: -15 }, unset: ["dwarf_grudge"] },
    right: { label: "I like books.", fx: { gold: 5 }, next: { id: "dwarf_grudge_2", delay: 4 } },
  },
  {
    ...
    left: { label: "Buy elf iron.", fx: { gold: -15, army: -5 } },
  ...
  },
  {
    ...
    left: { label: "Sign the apology.", fx: { people: -10, faith: -5, gold: 5 }, unset: ["dwarf_grudge"] },
  ...
  },
  {
    ...
    left: { label: "Ban the ale.", fx: { faith: 10, people: -10 }, unset: ["dwarf_ale"], set: ["dwarf_grudge"] },
    right: { label: "Truth is holy.", fx: { faith: -15, people: 5, gold: 5 } },
  },
  ...
  },
  {
    ...
    right: { label: "Send a volunteer.", fx: { people: -10, gold: 15 } },
  },
  {
    ...
    left: { label: "A crown.", fx: { faith: 15, gold: -15 } },
    right: { label: "A blade.", fx: { army: 15, gold: -15 } },
  },
  {
  ...
  },
  {
    ...
    left: { label: "It was a proposal.", fx: { people: 10, faith: -10, gold: -5 } },
  ...
  },
  {
    ...
    left: { label: "Hm.", fx: { people: 5, gold: 10 } },
  ...
  },
  {
    ...
    left: { label: "Fill it in.", fx: { gold: -10, army: 5 } },
