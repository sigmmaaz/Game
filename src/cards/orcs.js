...
export default [
  // ---------- everyday: the Scar ----------
  {
    ...
    left: { label: "Send another.", fx: { gold: 5, army: 5, people: -5 } },
    right: { label: "Keep the goats.", fx: { gold: -10, people: 5 } },
  },
  {
    ...
    left: { label: "Keep the cattle.", fx: { people: -5, army: 5 } },
    right: { label: "Send twenty back.", fx: { gold: -15, army: 5, people: 5 } },
  },
  {
  ...
  },
  {
    ...
    right: { label: "Let them count.", fx: { army: -15, people: 5 } },
  },
  {
    ...
    left: { label: "It means the well works.", fx: { people: 5 } },
    right: { label: "Double the watch.", fx: { gold: -10, army: 5 } },
  },
  {
    ...
    right: { label: "Send soldiers for him.", fx: { faith: 10, army: -10, gold: -5 } },
  },
  {
    ...
    left: { label: "Fix the price.", fx: { gold: -10, people: -5 } },
    right: { label: "Try it.", fx: { army: 5, people: -10 } },
  },
  {
    ...
    left: { label: "Send him.", fx: { gold: -5, people: -5 }, set: ["orc_ward"], next: { id: "orc_ward_2", delay: 2 } },
    right: { label: "Cities are bad for boys.", fx: { army: 5 } },
  },
  {
  ...
  },
  {
    ...
    right: { label: "Riders on the Scar.", fx: { gold: -10, army: 5 } },
  },
  {
  ...
  },
  {
    ...
    left: { label: "Flog them.", fx: { army: -15, people: -5 } },
  ...
  },
  {
    ...
    right: { label: "Church law is law.", fx: { faith: 10, army: -5, people: -5 } },
  },
  {
  ...
  },
  {
    ...
    left: { label: "Soldiers.", fx: { gold: -10, army: 5 } },
  ...
  },
  {
    ...
    left: { label: "Hunt together.", fx: { gold: -5, people: 5 }, random: [
  ...
  },
  {
    ...
    left: { label: "The border. Now.", fx: { army: 5, gold: -5 } },
  ...
  },
  {
    ...
    left: { label: "Half the toll.", fx: { gold: -10 } },
    right: { label: "Try it.", fx: {}, random: [
      { chance: 0.6, fx: { army: 5, gold: 5 } },
  ...
  },
  {
    ...
    left: { label: "Ban orc knives.", fx: { people: -5, gold: 5 } },
    right: { label: "Let them sell.", fx: { people: 5, gold: -5 }, set: ["orc_trade"] },
  },
  {
    ...
    right: { label: "Everyone kneels.", fx: { faith: 10 }, random: [
  ...
  },
  {
    ...
    right: { label: "Send a horse.", fx: { gold: -10, people: 5 } },
  },
  {
    ...
    left: { label: "Leave him.", fx: { people: 5 } },
  ...
  },
  {
    ...
    left: { label: "Hire the orc.", fx: { people: 10, gold: -5 } },
    right: { label: "Keep Pib.", fx: { people: -5 } },
  },
  {
    ...
    left: { label: "Move the fire.", fx: { faith: -10, gold: -5 } },
  ...
  },
  {
    ...
    left: { label: "Draft it.", fx: { gold: -5, people: -5, army: -5 }, set: ["orc_law"] },
    right: { label: "One law. Mine.", fx: { army: 5, people: 5 } },
  },
  {
    ...
    right: { label: "Treaties are for reading later.", fx: { army: 5, people: 5 } },
  },
  {
    ...
    left: { label: "One goat.", fx: { gold: -3, faith: -5 }, next: { id: "orc_comet_2", delay: 1 } },
  ...
  },
  {
    ...
    right: { label: "Double pay to stay.", fx: { gold: -25, army: 5 } },
  },
  {
    ...
    left: { label: "How much more?", fx: { gold: -25, army: 5 } },
    right: { label: "Let him have you.", fx: {}, random: [
  ...
  },
  {
    ...
    left: { label: "...Yes.", fx: { faith: -25, army: 15, people: -10 }, effect: "married", set: ["orc_queen"] },
  ...
  },
  {
    ...
    left: { label: "Hang the head.", fx: { people: 10, army: 5, faith: -5 }, next: { id: "orc_oath_5", delay: 6 } },
    right: { label: "Bury the swords.", fx: { faith: 5, people: 5 }, next: { id: "orc_oath_5", delay: 6 } },
  },
  {
    ...
    left: { label: "The word.", fx: { army: 20, gold: -10, faith: -5 } },
  ...
  // ---------- chain: the duel ----------
  {
    ...
    right: { label: "Kings don't duel.", fx: { people: -15, army: -15 }, set: ["orc_coward"], next: { id: "orc_duel_coward", delay: 1 } },
  },
  {
    ...
    right: { label: "Sir Gavriel fights for me.", fx: { army: -10, people: -10 }, set: ["orc_coward"], next: { id: "orc_duel_champion", delay: 0 } },
  },
  {
  ...
  },
  {
    ...
    left: { label: "Pay.", fx: { gold: -20 }, unset: ["orc_coward"] },
  ...
  // ---------- chain: mercenaries who don't leave ----------
  {
    ...
    left: { label: "Hire them.", fx: { gold: -20, army: 15, people: -10 }, set: ["orc_merc_hired"], next: { id: "orc_merc_2", delay: 2 } },
    right: { label: "We have swords.", fx: { army: -5 } },
  },
  {
    ...
    left: { label: "Contract ends in spring.", fx: { gold: -5 }, next: { id: "orc_merc_3", delay: 2 } },
    right: { label: "Stay.", fx: { army: 10, gold: -15, people: -10 }, next: { id: "orc_merc_4", delay: 3 } },
  },
  {
    ...
    left: { label: "Pay them off.", fx: { gold: -25, army: -10 }, unset: ["orc_merc_hired"] },
  ...
  },
  {
    ...
    right: { label: "Home. All of them.", fx: { army: -20, people: 5 }, unset: ["orc_merc_hired"] },
  },
  {
    ...
    left: { label: "A guild's a guild.", fx: { people: 5, gold: 5 } },
  ...
  // ---------- chain: refugees after the bad winter ----------
  {
    ...
    left: { label: "Open the ford.", fx: { people: -15, gold: -10 }, set: ["orc_refugees"], next: { id: "orc_ref_2", delay: 2 } },
    right: { label: "The Scar is closed.", fx: { army: 5, faith: 5 }, set: ["orc_grudge"], next: { id: "orc_ref_closed", delay: 1 } },
  },
  {
  ...
  },
  {
    ...
    left: { label: "Give them the field.", fx: { people: -10, gold: 5 }, next: { id: "orc_ref_3", delay: 3 } },
    right: { label: "They go home in spring.", fx: { people: 5, army: -5 }, next: { id: "orc_ref_3", delay: 3 } },
  },
  {
    ...
    left: { label: "Take the tax.", fx: { gold: 15, people: 5, faith: -5 }, next: { id: "orc_ref_4", delay: 2 } },
  ...
  },
  {
    ...
    left: { label: "Send priests.", fx: { faith: 10, people: -10 }, random: [
  ...
  },
  {
    ...
    left: { label: "Done.", fx: { gold: -20 }, set: ["orc_backed_shazza"], next: { id: "orc_shz_3", delay: 4 } },
  ...
  },
  {
    ...
    left: { label: "Peace on the Scar. A generation.", fx: { army: -5, people: 15, gold: 5 }, set: ["orc_peace"], unset: ["orc_grudge"] },
    right: { label: "Gold.", fx: { gold: 25, people: -5 } },
  },
  {
    ...
    left: { label: "Buy him.", fx: { gold: -20, army: 5 } },
  ...
  // ---------- chain: the shaman's dreams ----------
  {
    ...
    right: { label: "Pay for the next.", fx: { gold: -10, faith: -10 }, next: { id: "orc_vis_2", delay: 1 } },
  },
  {
    ...
    right: { label: "Whose hand?", fx: { gold: -10 }, next: { id: "orc_vis_3", delay: 2 } },
  },
  {
    ...
    left: { label: "Feed them, then.", fx: { gold: -15, people: -10, army: 5 }, set: ["orc_goodwill"], next: { id: "orc_vis_4", delay: 3 } },
  ...
  // ---------- chain: the Ashfang feast ----------
  {
    ...
    left: { label: "Go.", fx: { gold: -5 }, next: { id: "orc_feast_2", delay: 0 } },
  ...
  },
  {
    ...
    left: { label: "Blood price.", fx: { gold: -15, people: -5 } },
  ...
  },
  {
    ...
    right: { label: "Pay the mother.", fx: { gold: -20, people: -5 }, unset: ["orc_grudge"] },
  },
  {
  ...
  },
  {
    ...
    left: { label: "Sign.", fx: { gold: -25, army: -10 }, removeEffect: "war", unset: ["orc_war"], set: ["orc_grudge"] },
  ...
  },
  {
    ...
    left: { label: "Cattle.", fx: { gold: -15, people: 5 }, removeEffect: "war", unset: ["orc_war", "orc_grudge"] },
  ...
  // ---------- chain: traders ----------
  {
    ...
    left: { label: "Tax them at the gate.", fx: { gold: 10, people: -5 }, next: { id: "orc_trade_2", delay: 2 } },
  ...
  },
  {
    ...
    right: { label: "Tax the halflings.", fx: { gold: 10, people: -10 } },
  },
  {
    ...
    right: { label: "Don't ask.", fx: { people: 5, gold: 5 } },
  },
];
